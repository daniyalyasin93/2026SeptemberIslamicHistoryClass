...
**The early closes.** STOP A falls after #15 (ʿUmar ؓ and Mutammim); STOP B after #20 (the prisoner in the tent). Their closing sets are hidden at the end of the deck: in the slide show, type **135** and Enter for STOP A, **139** and Enter for STOP B. If the clock is past 0:36 at #20, close at STOP B. On the room's pace STOP B is also where the worksheet falls: take the 90 silent seconds there, then open Part IV. If instead the clock is kind, type **59** at the STOP C close and go on into Parts V–VIII, which end at STOP E. **You are not expected to reach the end of them.** If time runs out anywhere in there, do not hurry: type **99**, take the muṣḥaf card and the close, and whatever was not reached opens evening 5.
